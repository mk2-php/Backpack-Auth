Mk2 - backpack_auth (AuthBackpack)
====

AuthBackpack, one of the extended Backpacks of the MVC-compliant PHP framework "Mk2".

## # Description

This is Mk2's extended Backpack, AuthBackpack for user authentication.
...
AuthBackpack is initially installed in the installer.
...
[https://www.mk2-php.com/document/backpack/expand/auth](https://www.mk2-php.com/document/backpack/expand/auth)
...
```
composer require mk2/backpack_auth
```
